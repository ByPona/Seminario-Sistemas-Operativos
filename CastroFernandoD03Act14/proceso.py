class Proceso(object):
    ...
    def __init__(self, id, tamano, tiempo, transcurrido, operacion, operacion_resultado, tiempo_bloqueado, tiempo_de_llegada, tiempo_de_finalizacion, tiempo_de_retorno, tiempo_de_respuesta, tiempo_de_espera, tiempo_de_servicio, hora_inicial, tiempo_que_lleva_bloqueado,lista):
        self.id = id
        self.tamano = tamano
        self.tiempo = tiempo
    ...
    def establecerlista(self, lista):
        self.lista = lista
...
class Marco(object):
    ...
    def __init__(self, marcotamano, marcoid, marco_listo):
        self.marcotamano = marcotamano
        self.marcoid = marcoid    
        self.marco_listo = marco_listo

    def darmarcoid(self):
        return self.marcoid

    def darmarcotamano(self):
        return self.marcotamano    

    def __str__(self):
        return "ID: %s Tamaño: %s %s" % (self.marcoid, self.marcotamano, self.marco_listo)

    def darcadena(self):
        return "ID: %s Tamaño: %s %s" % (self.marcoid, self.marcotamano, self.marco_listo)
    
    def establecermarcolisto(self, marco_listo):
        self.marco_listo = marco_listo